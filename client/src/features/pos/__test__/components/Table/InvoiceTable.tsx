        ...
        return (
          <div className="flex flex-row gap-2">
            ...
            {row.original.product.brand ? (
              <span className="text-xs">({row.original.product.brand})</span>
            ) : null}
  ...
  return (
    <>
      ...
      <PrintTable
        ...
        deliveryCharge={
          fullData.delivery_charge > 0 ? fullData.delivery_charge : undefined
        }
        totalDue={fullData.total_amount_due}
        amountPaid={fullData.paid_amount > 0 ? fullData.paid_amount : undefined}
      />
      {/* )} */}
    </>
  );
