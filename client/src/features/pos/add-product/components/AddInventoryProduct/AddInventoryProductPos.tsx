...
import { AddInventoryProductForm } from './AddInventoryProductFormPos';
...
import { AddInventoryProductTable } from './AddInventoryProductTablePos';
...
export const AddInventoryProducts = ({
	...
	// Clear queue when inventoryId changes
	useEffect(() => {
	...
	return (
		<>
			<div className="flex flex-col gap-4">
				...
				<div
					className={`relative max-h-[65vh] min-w-[650px] overflow-x-clip transition-all duration-300 
					${
						activeTab === 'form'
