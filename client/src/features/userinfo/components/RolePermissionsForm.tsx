...
const RolePermissionsForm = () => {
	...
	return (
		<>
			...
			<ScrollArea type="always" className="bg-white">
				<div className={`flex flex-col grid-cols-12 h-[850px] mx-8 ${roleId === 0 ? 'blur-sm' : 'blur-none'}`}>
					<ScrollBar 
					...
					<div className="flex flex-col col-span-12 mx-4">
						<p className="text-2xl"> Transfers </p>
