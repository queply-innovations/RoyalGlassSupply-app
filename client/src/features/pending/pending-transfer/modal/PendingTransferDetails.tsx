			...
			<div className="flex max-w-4xl flex-col gap-4">
				<div className="mt-3 grid w-full grid-flow-row grid-cols-12 gap-4">
					<div className="col-span-6 flex flex-col justify-center gap-1">
						...
						<p className="text-sm text-gray-800">
							{selectedTransfer.code ? selectedTransfer.code : 'N/A'}
						</p>
					</div>
					<div className="col-span-3 flex flex-col justify-center gap-1">
						<h3 className="text-sm font-bold">Source</h3>
						<p className="text-sm text-gray-800">
							{selectedTransfer.source.name}
						</p>
					</div>
					<div className="col-span-3 flex flex-col justify-center gap-1">
						<h3 className="text-sm font-bold">Destination</h3>
						<p className="text-sm text-gray-800">
							{selectedTransfer.destination.name}
						</p>
					</div>
				</div>
				...
				<div className="grid w-full grid-flow-row grid-cols-6 gap-4">
					<div className="relative col-span-3 flex flex-col justify-center	gap-1">
						<h3 className="text-sm font-bold">Transfer status</h3>
						<p className="text-sm text-gray-800">
					...
					<div className="col-span-3 flex flex-col justify-center	gap-1">
						<h3 className="text-sm font-bold">Transfer schedule</h3>
						<p className="text-sm text-gray-800">
							{selectedTransfer.transfer_schedule.toString() ===
							'0000-00-00 00:00:00'
								? 'N/A'
					...
					<div className="col-span-3 flex flex-col justify-center	gap-1">
						...
						<p className="text-sm text-gray-800">
							{selectedTransfer.received_by
								? selectedTransfer.received_by.firstname +
									' ' +
									selectedTransfer.received_by.lastname
								: 'N/A'}
						</p>
					</div>
					<div className="relative col-span-3 flex flex-col justify-center	gap-1">
						<h3 className="text-sm font-bold">Date received</h3>
						<p className="text-sm text-gray-800">
