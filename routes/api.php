...
Route::group(['middleware' => 'auth:sanctum'], function() {
    ...
    Route::get('/invoices/search/code', [InvoiceController::class, 'searchCode']);
    ...
    Route::get('/inventory-products/pending/products', [InventoryProductController::class, 'pendingProducts']);
    ...
    Route::post('/reports/analytics', [ReportController::class, 'analytics']);
